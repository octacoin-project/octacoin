...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Octacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"octacoin.xyz", "seed.octacoin.xyz"},
    {"octacoin.net", "backupseed.octacoin.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Octacoin is probably already running."), addrBind.ToString().c_str());
        else
